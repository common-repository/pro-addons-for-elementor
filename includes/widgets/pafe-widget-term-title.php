...
/**
 * Elementor Term Title widget.
 *
 * Elementor widget that displays an eye-catching headlines.
 *
 * @since 1.0.0
 */
class PAFE_Widget_Term_Title extends \Elementor\Widget_Base {

  /**
   * Get widget name.
   *
   * Retrieve Term Title widget name.
   *
   * @since 1.0.0
   * @access public
   *
   ...
   * Get widget title.
   *
   * Retrieve Term Title widget title.
   *
   * @since 1.0.0
   * @access public
   *
  ...
  public function get_title() {
    ...
    return esc_html__( 'Term Title', 'pro-addons-for-elementor' );
   ...
   * Get widget icon.
   *
   * Retrieve Term Title widget icon.
   *
   * @since 1.0.0
   * @access public
   *
   ...
   *
   * Retrieve the list of categories the Term Title widget belongs to.
   *
  ...
  public function get_keywords() {
    ...
    return [ 'title', 'term', 'category', 'tag', 'taxonomy', 'dynamic', 'single', 'blog' ];

  }

  /**
   * Register Term Title widget controls.
   *
  ...
  protected function register_controls() {
    ...
    $this->start_controls_section(
      ...
      [
        ...
        'label' => esc_html__( 'Term Title', 'pro-addons-for-elementor' ),
    ...
    $this->add_responsive_control(
      ...
      [
        ...
        'selectors' => [
          ...
          '{{WRAPPER}} .pafe-term-title' => 'text-align: {{VALUE}};',
    ...
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          ...
          '{{WRAPPER}} .pafe-term-title' => 'color: {{VALUE}};',
    ...
    $this->add_group_control(
      ...
      [
        ...
        'selector' => '{{WRAPPER}} .pafe-term-title',
    ...
    $this->add_control(
      ...
      [
        ...
        'selectors' => [
          ...
          '{{WRAPPER}} .pafe-term-title' => 'mix-blend-mode: {{VALUE}}',
  ...
  /**
   * Render Term Title widget output on the frontend.
   *
  ...
  protected function render() {
    ...
    $term_title = $before_text . ' ' . $term_title . ' ' . $after_text;


    $term_title_html = sprintf( 

      '<%1$s class="pafe-term-title">%2$s</%1$s>', 
    ...
    // PHPCS - the variable $term_title_html holds safe data.
    echo $term_title_html; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
